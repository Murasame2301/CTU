...
function Is-NoteLine {
    ...
    return $normalized -match '^(chuong 3:|-?\s*ghi chu:|ghi chu:|answer:|chon dap an chinh xac nhat:?$)'
}
...
$docxPath = 'TNChuong3.docx'
$backupPath = 'TNChuong3.backup-before-reorder.docx'
