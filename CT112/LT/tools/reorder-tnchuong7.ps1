...
function Is-NoteLine {
    ...
    return $normalized -match '^(chuong 7:|chon dap an chinh xac nhat:?$|a->b|b->a)'
}
...
$docxPath = 'TNChuong7.docx'
$backupPath = 'TNChuong7.backup-before-reorder.docx'
