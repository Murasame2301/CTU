...
- Có vỏ bọc đặc biệt quấn xung quanh dây dẫn có tác dụng chống nhiễu
- Sử dụng đầu nối: **STP**

#### UTP (Unshielded Twisted Pair):
- được sử dụng trong hệ thống mạng hình sao
- Sử dụng đầu nối **RJ45**
- Chiều dài tối đa: **100m**
- Khả năng chống nhiễu kém, chỉ nên đi trong nhà
- Hiện nay được sử dụng phổ biến nhất trong mạng LAN
...
1. **Cáp quang chế độ đơn:**
Các tia sáng di chuyển bằng cách phản xạ giữa bề mặt của 2 môi trường có chiết suất khác nhau (n2>n1) -> tia sáng được tập trung nên truyền đi nhanh
3. **Chế độ đa không thẩm thấu:** Các tia sáng di chuyển bằng cách phản xạ giữa bề mặt của 2 môi trường có chiết suất khác nhau $n_2 > n_1$) → mất nhiều thời gian hơn để các sóng di chuyển so với chế độ đơn
4. **Chế độ đa thẩm thấu:** Chiết suất tăng dần từ trung tâm về vỏ của ống → sự phản xạ trong trường hợp này rất nhẹ nhàng
...
- Tín hiệu có **tần số càng cao** thì độ phát tán càng thấp (phạm vi truyền ngắn), ví dụ:
...
$\rightarrow$ Tín hiệu có **độ dài sóng càng lớn** thì khoảng cách **truyền càng xa** mà không bị suy giảm

- **Mạng không dây** là mạng điện thoại hoặc mạng máy tính sử dụng sóng radio làm sóng truyền dẫn hay tầng vật lý.
- **Mạng LAN không dây (WLAN)**: mạng cục bộ không dây
- **IEEE 802.11** là một tập các chuẩn, bao gồm các đặc tả kỹ thuật liên quan đến hệ thống mạng không dây
...
- $w$: nhịp; $f = \dfrac{\omega}{2\pi}$: là tần số;
- $T = \dfrac{\omega}{2\pi} = \dfrac{1}{f }$: là chu kỳ.

$v_{out}(t) = V_{out}sin(\omega t + F)$
...
- $\dfrac{V_{out}}{V_{in}} = (1 + R^2C^2\omega^2)^{-\frac{1}{2}}$
- $F = arctan(-RC \omega)$
